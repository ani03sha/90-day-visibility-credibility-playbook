...
- **Time Commitment:** 10–12 hrs/week — non-negotiable.
- **Mindset:** Output over effort — no one hires you for how "busy" you were.
...
📁 **[Phase 3 Resources](phase-3-proof-amplify/)**
...
1. **[Polish Your Project](phase-3-proof-amplify/project-polish-checklist.md)**
   ...
   - **Done When:** Project passes the "would I put this on my résumé?" test.
...
1. **Building in isolation** → No one sees your work
2. **Waiting until "ready"** → You never feel ready enough
3. **Focusing on perfect code** → Ignoring communication and visibility
4. **Applying to hundreds of jobs** → Instead of building relationships
...
👉 **Start with [Phase 1: Choose Your Niche](phase-1-foundation/niche-selection.md)**
